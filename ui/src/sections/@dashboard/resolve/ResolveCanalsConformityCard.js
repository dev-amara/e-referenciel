...
ResolveCanalsConformityCard.propTypes = {
  referential: PropTypes.object.isRequired,
};

export default function ResolveCanalsConformityCard({ referential }) {
...
export function ResolveContent({ title }) {
  ...
  const linkTo = PATH_DASHBOARD.canalsConformity.view(paramCase(title));
