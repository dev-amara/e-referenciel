...
ResolveReferentialCard.propTypes = {
  referential: PropTypes.object.isRequired,
};

export default function ResolveReferentialCard({ referential }) {
...
export function ResolveContent({ title }) {
  ...
  const linkTo = PATH_DASHBOARD.referential.view(paramCase(title));
